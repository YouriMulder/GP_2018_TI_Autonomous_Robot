...
void init_motors() { BP_wheels.detect(); }

/**
 * starts driving the robot straight forward or backward
 * @param speed a float that controls the speed of the motors 0-100
 * @param f_r is a char that defines the direction of the motors 'f' means
 * forward, 'r' means reverse
 */
...
// calls free()
void reset_motors() { free(); }

/**
 * turns robot on it's place
 * @param f_r a char that defines the direction of the motors 'f' means forward,
 * 'r' means reverse
